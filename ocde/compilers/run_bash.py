...
if __name__ == "__main__":
    ...
    execute = subprocess.run("chmod +x {}".format(code_filename) ,shell=True,capture_output=True, stdin = input_file)
    execute = subprocess.run("timeout "+ tl+ " bash {}".format(code_filename) + " "+cli,shell=True,capture_output=True, stdin = input_file)
